  ...
  group("PlotYAxisLabelWidget widget tests", () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final channels = {
          "Test": ChannelSetting(minY: 0, maxY: 10, lineColor: Colors.red),
        };
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // When I build the PlotYAxisLabelWidget with a normalizedValue of 0, 0.1, 0.5 and 1
        final channels = {
          "Test": ChannelSetting(minY: -10, maxY: 10, lineColor: Colors.red),
        };
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final channels = {
          "Test1": ChannelSetting(lineColor: Colors.red, minY: -10, maxY: 10),
